...
//for active slide
//$sql2 = "SELECT * FROM services where status='active' order by id DESC LIMIT 1";
//$result2 = mysqli_query($link, $sql2);

//for active slide
//$sql3 = "SELECT * FROM services where status='notactive' order by id DESC";
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          >
            <h1 class="h2">Dashboard-Services</h1>
      ...
      <table class="table table-bordered">
        ...
        ?>
          ...
          <tr>
            ...
            <td>
              <img src="<?php echo $row['path']; ?>" width="80">
            </td>
            <td>
        <!-- EDIT BUTTON -->
        <a href="update_service.php?id=<?php echo $row['id']; ?>" 
