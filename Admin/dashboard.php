...
//for active slide
$sql2 = "SELECT * FROM slider where status='active' order by id DESC LIMIT 1";
$result2 = mysqli_query($link, $sql2);

//for active slide
$sql3 = "SELECT * FROM slider where status='notactive' order by id DESC";
      ...
      <table class="table table-bordered">
        ...
        ?>
          ...
          <tr>
            ...
            <td>
        <!-- EDIT BUTTON -->
        <a href="update_slide.php?id=<?php echo $row['id']; ?>" 
