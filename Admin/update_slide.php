...
<html lang="en" data-bs-theme="auto">
  ...
  <div class="col-md-6">
    <div class="card p-4 shadow">
      ...
      <form method="POST" action="update_slider_details.php">
 ...
 <?php
  ...
  <form method="POST" action="update_slider_img.php" enctype="multipart/form-data">

          <div class="mb-3 text-center">
            <label>Current Image</label><br>
            <img src="<?php echo $row['path']; ?>" width="200">
          </div>
