...
$sql = "SELECT * FROM album_images WHERE album_id = $id  order  by id DESC";
...
<html lang="en" data-bs-theme="auto">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          >
            <h1 class="h2">Dashboard / Gallery / <?php echo $title;?></h1>
  ...
  <div class="col-md-6">
    <div class="card p-4 shadow">
      ...
      <form method="post" action="save_image.php" enctype="multipart/form-data">
                ...
                <input type="hidden" name="albumtitle" value="<?php echo $title;?>" class="form-control"/>
  ...
  <div class="col-md-12">
    <div class="card p-4 shadow">
      <h4>Image List under <u><?php echo $title;?></u></h4>
    ...
    ?>
      ...
      <div class="col-sm-4">
     <img src="<?php echo $row['path']?>" class="d-block w-100 c-img img-circle" alt="Slide">
                ...
                <div class="card-body">
                  ...
                  <p><a class="btn btn-xs btn-info" href="delete_image.php?id=<?php echo $row['id']?>&title=<?php echo $row['title']?>">Delete Image</a></p>
                </div>
