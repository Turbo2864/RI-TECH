...
<?php
    ...
    $result = mysqli_query($link, $sql);
     ...
     $sql1="SELECT * FROM slider where status = 'notactive'";
...
.img-circle {
    ...
    border-radius: 85%;        /* Makes the image circular */
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              <li class="nav-item">
                ...
                <a class="nav-link active" aria-current="page" href="#">Club</a></li>
                 <a class="nav-link active" aria-current="page" href="#">Schedule</a></li>
      ...
      <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item <?php if($first){ echo 'active'; $first = false; } ?>">
            <img src="admin/<?php echo $row['path']?>" class="d-block w-100 c-img" alt="Slide">
            ...
            <div class="container">
              ...
              <div class="carousel-caption text-start">
                ...
                <p>
                  <a class="btn btn-lg btn-primary" href="<?php echo $row['link']?>">Sign up today</a>
                </p>
              </div>
          ...
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption">
                ...
                <p><a class="btn btn-lg btn-primary" href="<?php echo $row['link']?>">Read more</a></p>
              </div>
            </div>
          </div>
      ...
      <div class="container marketing">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
           ...
           <img src="admin/<?php echo $row['path']?>" class="d-block w-100 c-img img-circle" alt="Slide">
            
            <h2 class="fw-normal"><?php echo $row['title']?></h2>
            <p>
              <?php echo $row['description']?>
            </p>
            <p>
              <a class="btn btn-secondary" href="<?php echo $row['link']?>">View details &raquo;</a>
            </p>
